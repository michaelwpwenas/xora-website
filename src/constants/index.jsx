export const features = [
  {
    ...
    caption: "Metatronics",
    title: "Engineer the cosmos",
    text: "With Navajagat OS, observe and administer the cosmic engineering process of Metatronics. Make sure dark energy can be harnessed and transmuted into material, and anti-material energy of light, before you collide them.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Access IDRIS O.I.",
    },
  },
  {
    id: "1",
    icon: "/images/feature-2.png",
    caption: "Sandalphonics",
    title: "Manage all consciousness",
    text: "With Navajagat OS, you can collect and connect the consciousness of all carbon-based intelligent species. We no longer need to rely on artificial afterlife, when we can stay connected universally at all times.",
    button: {
      icon: "/images/docs.svg",
      title: "Access ELIA O.I.",
    },
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 77,
    priceYearly: 33,
    caption: "Combined guilds of spiritual adepts",
    features: [
      "Access to Kalkiyama role",
      "Intergalactic ecumenical councils",
  ...
  },
  {
    ...
    priceMonthly: 66,
    priceYearly: 22,
    caption: "Union of Socialist Republics",
    features: [
      "Access to Padmamitra role",
      "Intergalactic internationalism",
      "Soft power consolidations",
      "Aggressive strategizing",
    ],
  ...
  },
  {
    ...
    priceMonthly: 33,
    priceYearly: 11,
    caption: "For those who do not wish to participate.",
    features: [
      "Gnostic Atheism",
      "Spiritual cynicism",
      "Bamboozling religious kooks",
      "Illuminati's greatest legacy",
    ],
